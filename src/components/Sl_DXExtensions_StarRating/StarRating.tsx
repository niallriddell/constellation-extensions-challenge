...
const SlDXExtensionsStarRating: FunctionComponent<SlDXExtensionsStarRatingProps & ForwardProps> = forwardRef(function StarRating(
  ...
  return (
    <Flex container={{ direction: 'row' }}>
      ...
      {
        metaInfoUpdated && <Flex item={{ shrink: 0 }}>
